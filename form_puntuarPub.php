...
<body>
	   ...
	   <nav class="navbar navbar-default navbar-fixed-top  "> <!--Barra de Menu Top-->
	  	...
	  	<div class="row-fluid">	<!--Cuerpo de Pagina -->
	    	...
	    	<div class="col-sm-6"> <!-- Cuerpo Central -->
			    ...
			    <form id="registro" name="registro"  class="form-horizontal" action = "contr_puntuarPub.php?idpub=<?php echo $_GET['idpub']; ?>" method = "post">
					<br>
					<br>
					<br>
					<br>
					<br>
				    <legend>Puntuar Publicacion</legend>		 
				    <br>   		
				    ...
				    <div class="form-group">
				        <div class="col-xs-offset-3 col-xs-9">
				            <input id="registrar" type="button" class="btn btn-primary" value="Enviar" onclick="PuntajePub()" > <!-- Envia el Formulario con los datos ingresados-->
	...
	<script src="JS/PuntajePub.js"></script>
</html>