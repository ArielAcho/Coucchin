...
<body>
	<div class="container">
	    <nav class="navbar navbar-default navbar-fixed-top  "> <!--Barra de Menu Top-->
	  	...
	  	<div class="row">
	    	<div class="col-sm-4"> <!--Cuerpo de Pagina -->
	        	<!-- Cuerpo de Pagina Derecho-->
	        	
	    	</div>
	    	<div class="col-sm-4"> <!--Cuerpo de Pagina Central -->
	    			<br>
					<br>
					<br>
					<br>
					...
					<br>
					<br>
	      		<a href="#"><img src="bs/img/logo1.png" class="img-thumbnail" alt="Couchin"</a>
	    	</div>
	    	<div class="col-sm-4"> <!--Cuerpo de Pagina -->
	        	<!--Cuerpo de Pagina Izquierdo -->
	   		</div>
		</div>
	</div>
</body>
