...
<?php enlaces() ?>
	  			...
	  			<div class="col-xs-5 col-md-5">
					...
					<?php
						$f_id=$_GET['publi']['0'];
						$f_titulo=$_GET['publi']['3'];
						$f_descripcion=$_GET['publi']['4'];
						$f_imagen=$_GET['publi']['1'];
						$f_direccion=$_GET['publi']['8'];
						$f_capacidad=$_GET['publi']['10'];
					...
					<form name="crear_pub"  class="form-horizontal col-sm-12" action = "../contr_mod_pub.php" method = "POST" enctype="multipart/form-data">   
						...
						<div class="form-group">
					        ...
					        <div class="col-xs-9">
					            <input type="text" size="40" class="btn btn-default" name= "titulo" placeholder="Titulo" value="<?php echo $_GET['publi']['3']; ?>">
					        </div>
					    </div>
					    <div class="form-group"> 
					        <label class="control-label col-xs-3">Descripcion:</label>
					        <div class="col-xs-9">
					            <input type="text" size="40" class="btn btn-default input-lg" name="descripcion" placeholder="Descripcion" value="<?php echo $_GET['publi']['4']; ?>">
					        </div>
					    </div>
					    <div class="form-group">
					        <label class="control-label col-xs-3">Agrega Imagen:</label>
					        <div class="col-xs-3">
					            <input type="file" size="40" class="btn btn-default" name="alex" value="<?php echo $_GET['publi']['1']; ?>">
					        </div>
					    </div>
					    <div  class="form-group">
					    ...
					    <div class="form-group"> 
					        ...
					        <div class="col-xs-9">
					            <input type="text" size="40" class="btn btn-default" name="direccion" placeholder="Direccion" value="<?php echo $_GET['publi']['8'] ?>">
					        </div>
					    </div>
						<div class="form-group"> 
					        <label class="control-label col-xs-3">Capacidad:</label>
					        <div class="col-xs-9">
					           <input type="text" size="40" class="btn btn-default" name="capacidad" placeholder="Direccion" value="<?php echo $_GET['publi']['10'] ?>">
					        </div>
					    </div>
					    <div class="form-group">
