...
<?php enlaces() ?>
	  			...
	  			<div class="col-xs-5 col-md-5">
					...
					<form name="modHosp" class="form-horizontal" action = "contr_th_mod.php" method = "post"> 
					    <div class="form-group"> <!-- Ingresa tipo de hospedaje-->
					        <label class="control-label col-xs-3">T. de Hosp. a Modificar:</label>
					        <div class="col-xs-9">
					            <input type="text" class="btn btn-default" name="nom_th1" placeholder="T. de Hosp.">
					        </div>
					    </div>
					    <div class="form-group"> <!-- Ingresa tipo de hospedaje-->
					        <label class="control-label col-xs-3">Nuevo T. de Hosp.:</label>
					        <div class="col-xs-9">
					            <input type="text" class="btn btn-default" name="nom_th2" placeholder="Nuevo T. de Hosp.">
					        </div>
					    </div>
					    <div class="form-group">
					        <div class="col-xs-offset-3 col-xs-9">
					            <input type="submit" class="btn btn-primary" value="Enviar" onclick="return validarModificarHospedaje()"> <!-- Envia el Formulario con los datos ingresados-->
...
<script src="../JS/validarModificarHospedaje.js"></script>
</body>
</html>